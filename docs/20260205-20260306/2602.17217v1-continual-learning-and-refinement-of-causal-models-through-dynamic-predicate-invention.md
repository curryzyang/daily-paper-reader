...
score: 8.0
evidence: 通过谓词发明构建符号因果世界模型
tldr: 本研究针对现有世界模型在复杂环境中样本效率低、透明度差及扩展性难的问题，提出一种在线构建符号化因果世界模型的框架。该框架结合了元解释学习与动态谓词发明技术，使智能体能在决策循环中持续学习并修复模型，从而从观测中提取出具有语义且可重用的高阶抽象概念。实验表明，该方法在处理复杂关系动力学时具有极高的样本效率，远超PPO等神经网络基准，并有效克服了传统命题方法的组合爆炸难题。
